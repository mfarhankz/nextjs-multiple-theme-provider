...
const Navbar = () => {
  return (
    <header className="flex flex-wrap bg-white lg:px-32 justify-start sm:flex-nowrap z-50 w-full text-sm py-[10px] px-12">
      <nav className="flex justify-between w-full lg:justify-around sm:items-center" aria-label="Global">
        ...
        <div id="navbar-with-collapse" className="hidden basis-full grow lg:block">
          <div className="flex sm:flex-row sm:items-center sm:justify-end md:justify-between sm:mt-0 sm:pl-10">
            <div className='flex items-end ms-6 lg:mt-1'>
        ...
        <div className='flex items-center'>
          <button type="button" className="inline-flex gap-2 p-2 text-sm font-medium text-gray-700 transition-all bg-white rounded-md shadow-sm hs-collapse-toggle lg:hidden hover:bg-gray-50 focus:outline-none item-ceter focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800 ps-auto" data-hs-collapse="#navbar-with-collapse" aria-controls="navbar-with-collapse" aria-label="Toggle navigation">
