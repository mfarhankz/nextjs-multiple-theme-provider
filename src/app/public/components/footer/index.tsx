    ...
    <>
      <footer className='py-32'>
        <div className="lg:px-28 lg:flex justify-between border-gray-300 border-b pb-9 mx-4">
          ...
          <div>
            <ul className='md:inline-flex md:gap-9 gap-2 mt-5'>
              <li>
        ...
        <div className="lg:px-28 pt-9">
          <div className='lg:flex justify-between p-4'>
            <div className='lg:w-[687px]'>
              <p className='text-sm font-extralight tracking-[-0.6px] text-[#64607D]'>
                At our company, we are dedicated to supporting you in the seamless creation of exceptional content that is both efficient and high in quality. Our expert team and advanced AI-powered tools work hand in hand to assist you in effortlessly producing top-notch content that captivates your audience.
              </p>
            </div>
            <div className='flex items-center lg:mt-0 mt-9'>
              <div className='flex gap-6'>
                <a href="#" className='h-8 w-8 flex items-center justify-center'>
